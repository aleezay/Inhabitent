<?php
/**
 * Inhabitent Business hours Widget Boilerplate
 *
 * The Inhabitent Business Hours Widget Boilerplate is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent_Business_Hours
 * @author    Aleezay <aleezayh@hotmail.com>
 * @license   GPL-2.0+
 ...
 * Description:       Inhabitent Business hours Widget Boilerplate
 * Version:           1.0.0
 * Author:            Aleezay 
...
class Inhabitent_Business_Hours extends WP_Widget {
	...
	public function widget( $args, $instance ) {
	  ...
	  $saturday = empty( $instance['saturday'] ) ? '' : apply_filters( 'widget_title', $instance['saturday'] );
		...
		//including this widget in our views folder.two different views: backend and frontend
